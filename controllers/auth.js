...
const loginCtrl = async (req, res) => {
    try {
        req = matchedData(req)
        const user = await usersModel.findOne({ email: req.email }).select("password name role email isVerified")
...
const verifyAdminCtrl = async (req, res) => {
    try {
...
module.exports = { registerCtrl, loginCtrl, verifyCodeCtrl, verifyAdminCtrl };